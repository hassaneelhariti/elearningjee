...
<body>
    ...
    <div class="sidebar">
        ...
        <ul class="nav-menu">
            <li><a href="${pageContext.request.contextPath}/student-dashboard" class="active">
                <i class="fas fa-home"></i> Dashboard
            </a></li>
            <li><a href="${pageContext.request.contextPath}/my-courses">
            ...
            <div class="header-actions">
                ...
                <div class="user-profile">
                    <div class="user-avatar">
                        ${not empty userFirstName ? fn:substring(userFirstName, 0, 1) : 'U'}
                    </div>
                    <div>
